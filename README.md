...
- Integrate [TLG1](https://github.com/manish-andankar/Alpha-White-Label-Lead-Generator/edit/TLG1/README.md) and [TLG2](https://github.com/manish-andankar/Alpha-White-Label-Lead-Generator/edit/TLG2/README.md) to create the final GCP Serverless APIs that interact with GCP Cloud Spanner Database for White Label Lead Generator App.
...
### Tools to use/avoid
As described in [TLG1](https://github.com/manish-andankar/Alpha-White-Label-Lead-Generator/edit/TLG1/README.md) and [TLG2](https://github.com/manish-andankar/Alpha-White-Label-Lead-Generator/edit/TLG2/README.md).

### Deliverables
- Completed Code of Integrated GCP Serverless APIs with GCP Cloud Spanner Database that combines [TLG1](https://github.com/manish-andankar/Alpha-White-Label-Lead-Generator/edit/TLG1/README.md) and [TLG2](https://github.com/manish-andankar/Alpha-White-Label-Lead-Generator/edit/TLG2/README.md) is checked in to the repository with a *unique folder* that indicates your contribution. It is the *parent* folder for all deliverables.
